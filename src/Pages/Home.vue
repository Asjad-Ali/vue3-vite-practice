<template>
      ...
      >
        <li class="menu-first-li">
          ...
          <div class="grid-container2">
            <ul>
              <li>
                <a href="index2.html"><i class="fa fa-globe"></i>Home Page 1</a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li aria-haspopup="true">
          ...
          <div class="grid-container4">
            <ul>
              <li>
                <a href="details.html"
                  ><i class="fa fa-check"></i>Details Page</a
                >
              </li>
              <li>
                <a href="blog.html"><i class="fa fa-check"></i>Blog</a>
              </li>
              <li>
                <a href="blog_column.html"
                  ><i class="fa fa-check"></i>Blog Right Column</a
                >
              </li>
            </ul>
          </div>
              ...
              <div class="fullwidthbanner">
                <ul>
                  ...
                  >
                    ...
                    <div
                      class="caption lfl small_text img-arleft"
                      data-x="-60"
                      data-y="150"
                      data-speed="600"
                      data-start="1600"
                    ...
                    >
                      <img src="images/slides/power.png" alt="" />
                    </div>
                    <div
                      class="caption lfl small_text img-arleft"
                      data-x="-40"
                    ...
                    <div
                      class="caption lft medium_black"
                      data-x="70"
                      data-y="190"
                      data-speed="400"
                      data-start="1000"
                      data-easing="easeOutExpo"
                    >
                      <p class="blackbold">RESPONSIVE</p>
                    </div>
                    <div
                      class="caption fade medium_black"
                      data-x="70"
                      data-y="300"
                      data-speed="600"
                      data-start="1500"
                    ...
                    >
                      <p>TOUCH SWIPE NAVIGATION</p>
                    </div>
                    <div
                      class="caption sfb small_text"
                      data-x="80"
                      data-y="390"
                      data-speed="1200"
                      data-start="2400"
                    ...
                    <div
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/line1.png" alt="" />
                    </div>
                    <div
                      class="caption sfr small_text_desc"
                      data-x="530"
                      data-y="350"
                      data-speed="900"
                      data-start="2500"
                  ...
                  >
                    ...
                    <div
                      class="caption sfr small_text imgimac"
                      data-x="440"
                      data-y="320"
                      data-speed="500"
                      data-start="1200"
                    ...
                    <div
                      class="caption sfr small_text imgipad"
                      data-x="420"
                      data-y="430"
                      data-speed="600"
                      data-start="1800"
                    ...
                    <div
                      ...
                      data-easing="easeOutExpo"
                    >
                      <p class="blackbold">Your poker web site</p>
                    </div>
                    <div
                      class="caption lft medium_black"
                      data-x="40"
                  ...
                  >
                    ...
                    <div
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/banner1-man.png" alt="" />
                    </div>
                    <div
                      class="caption lft medium_black"
                      data-x="70"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <p class="blackbold">Your game your money</p>
                    </div>
                    <div
                      class="caption lft medium_black"
                      data-x="70"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <p>Million solution</p>
                    </div>
                    <div
                      class="caption lfl small_text"
                      data-x="150"
                      data-y="320"
                      data-speed="900"
                      data-start="1400"
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/rb.png" alt="" />
                    </div>
                    <div
                      class="caption lfl small_text"
                      data-x="-20"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/ru.png" alt="" />
                    </div>
                    <div
                      class="caption lfr small_text"
                      data-x="600"
                      data-y="320"
                      data-speed="900"
                      data-start="1400"
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/lb.png" alt="" />
                    </div>
                    <div
                      class="caption lfr small_text"
                      data-x="800"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/lu.png" alt="" />
                    </div>
                    <div
                      class="caption lfl small_text"
                      data-x="110"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/b.png" alt="" />
                    </div>
                    <div
                      class="caption lfl small_text"
                      data-x="-70"
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/a.png" alt="" />
                    </div>
                    <div
                      class="caption lfr small_text"
                      data-x="620"
                    ...
                    <div
                      ...
                      data-easing="easeOutExpo"
                    >
                      <img src="images/slides/c.png" alt="" />
                    </div>
                  </li>
                </ul>
        ...
        <ul class="ca-menu">
            ...
            <div class="box-content">
              <div class="box-info">
                <div class="img-content">
                  <img class="ca-icon" src="images/2.jpg" alt="" />
                </div>
          ...
          <li class="select">
            <div class="box-content">
              <div class="box-info">
                <div class="img-content">
                  <img class="ca-icon" src="images/1.jpg" alt="" />
                </div>
          ...
          <li>
            <div class="box-content">
              <div class="box-info">
                <div class="img-content">
                  <img class="ca-icon" src="images/3.jpg" alt="" />
                </div>
          ...
          <li>
            <div class="box-content">
              <div class="box-info">
                <div class="img-content">
                  <img class="ca-icon" src="images/4.jpg" alt="" />
                </div>
                <div class="ca-content">
        ...
        <div class="container">
          <section>
            <article id="blockTitle6">
              <h2 class="section_title_white">
                Hold 'em <span class="secondtxt">Tournaments</span>
              </h2>
            </article>
          </section>
          <br />
          <section id="calendartable">
            <article>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_one">
                  <li class="speciallist">
                    <a href="#info1" class="fancybox_table thumb">
                      Db Chance
                    </a>
                    <p>20.00</p>
                  </li>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_one">
                  <li>
                    <a href="#info2" class="fancybox_table thumb">
                      Bounty Mon
                    </a>
                    <p>20.00</p>
                  </li>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_two">
                  <li class="speciallist">
                    <a href="#info3" class="fancybox_table thumb"> Freezout </a>
                    <p class="value">22.00</p>
                  </li>
                  <li>
                    <a href="#info3" class="fancybox_table thumb"> Freezout </a>
                    <p class="value">22.00</p>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_three">
                  <li>
                    <a href="#info4" class="fancybox_table thumb"> Lucky </a>
                    <p class="value">19.00</p>
                  </li>
                  <li class="speciallist">
                    <a href="#info4" class="fancybox_table thumb"> Lucky </a>
                    <p class="value">19.00</p>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_four">
                  <li class="speciallist">
                    <a href="#info5" class="fancybox_table thumb">
                      Db Chance
                    </a>
              ...
              <div class="one_sixth">
                ...
                <ul class="item_five">
                  <li>
                    <a href="#info6" class="fancybox_table thumb">
                      Deep Stack
                    </a>
                    <p class="value">22.00</p>
                  </li>
              ...
              <div class="one_sixth lastcolumn">
                ...
                <ul class="item_six">
                  <li class="speciallist">
                    <a href="#info7" class="fancybox_table thumb">
                      Freezeout
                    </a>
                    <p>21.00</p>
                  </li>
      ...
      <div class="parallax">
        <article class="clearfix">
          <div class="container services-our">
            <h2 class="section_title_white">
              Our <span class="secondtxt">Services</span>
            </h2>
            <div class="one_fourth">
              <div class="box">
                <div class="image">
                ...
                <div class="text">
                  <div>
                    <h4 class="nocaps">Design</h4>
                    Lorem ipsum dolor sit amet, consectetuer elit. Suspen disse
                    et justo.
                  </div>
                </div>
              </div>
  ...
  <div id="section-4" class="eventsgallery">
    <div class="container gallery">
      <div id="blockTitle5" class="block_title">
        ...
        <div class="g-hr type_short">
          <span class="g-hr-h"><i class="fa fa-eye"></i></span>
        </div>
        <h3 class="subtitle_poker">
          Proin gravida nibh vel velit auctor aliqued
        </h3>
      ...
      <div class="box-filter">
        ...
        <div class="controls">
          <ul class="filter-buttons">
            <li
              class="sort active sort-firs"
              data-sort="default"
              data-order="desc"
            >
              Default
            </li>
            <li class="sort" data-sort="data-cat" data-order="desc">
              Descending
            </li>
            <li class="sort" data-sort="data-cat" data-order="asc">
              Ascending
            </li>
          </ul>
        </div>
    ...
    <ul id="Grid" class="grid cs-style-1">
      <!-- GRID -->
        ...
        <figure class="2014 clearfix">
          <div class="layer">
            <div class="portfolio-info">
              ...
              <div class="link-view">
                <a href="more_details.html">View</a>
              </div>
            </div>
          </div>
        ...
        <figure class="2014 clearfix">
          <div class="layer">
            <div class="portfolio-info">
              ...
              <p class="gallery_desc">
                <i class="fa fa-calendar-o"></i> Date: 14/10/2013
              </p>
              <p class="gallery_desc">
                <i class="fa fa-clock-o"></i> Time: 17:00
              </p>
              <p class="gallery_desc">
                <i class="fa fa-money"></i> Buy-in: $650+50
              </p>
  ...
  <section id="testimonial">
    <div class="container">
      <h2 class="section_title_white">
        Our <span class="secondtxt">Testimonials</span>
      </h2>
      <hr class="separator2" />
      <section class="sponsors">
        <article id="sponsorpoker">
          <div class="one_sixth_sponsor">
            <a href="#"><img class="" src="images/brand-logo2.png" alt="" /></a>
          </div>
          <div class="one_sixth_sponsor">
            <a href="#"><img class="" src="images/brand-logo3.png" alt="" /></a>
          </div>
          <div class="one_sixth_sponsor">
            <a href="#"><img class="" src="images/brand-logo4.png" alt="" /></a>
          </div>
          <div class="one_sixth_sponsor">
            <a href="#"><img class="" src="images/brand-logo7.png" alt="" /></a>
          </div>
          <div class="one_sixth_sponsor">
            <a href="#"><img class="" src="images/brand-logo5.png" alt="" /></a>
          </div>
          <div class="one_sixth_sponsor lastcolumn">
            <a href="#"><img class="" src="images/brand-logo1.png" alt="" /></a>
          </div>
        </article>
      </section>
    </div>
      ...
      <div class="content-contact">
        ...
        <div class="footer-top-content">
          <div class="container">
              ...
              <div class="two_third_contact">
                <div class="one_fourth">
                  ...
                  <p>
                    ...
                    Aenean nibh magna, fringilla sit amet lobortis id, posuere
                    sit amet metus.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur Aenean nibh magna,
                    fringilla sit amet.
                  </p>
                </div>
                <div class="one_fourth">
            ...
            <p class="copyright">
              &copy; 2013 by <a href="#">Corsaro Design</a>. All Rights Reserved
            </p>
          </div>
        </div>
      </div>
